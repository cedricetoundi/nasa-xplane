...
class TaxiingExperiment(BaseExperiment):
    def __init__(self, config, core):
        super().__init__(config, core) # Initializes TaxiingExperiment by calling the contructor of its parent class (Base Experiment).
        # It is represented by "super()"
        self._initial_setup() # Called to perform initializations specific to the class
